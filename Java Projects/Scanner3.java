...
Date dd;
MenuBar mb;
JButton jk1,jk2,jk3,jk4,jk5,b1,b2,b3,b4,b5,g1,g2,g3;
JToolBar tb;
JList jh;
File autorun;
int jdk=1;
...
logFile.write("*************************** $E-Security$ ****************************************"+"\r\n");
logFile.write("                                           Author- Pravin H. Rane"+"\r\n");
logFile.write("*********************************************************************************"+"\r\n");
...
jf=new JFrame("Virus Blocker 1.0.0.1");
jf.setLayout(null);
...
jfc.add(rr);
		...
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Author: Pravin H. Rane \n");
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Tester: Rahul Sadafule \n");
		//Thread.sleep(2000);
		...
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Realising Date: 1 OCT 2010 \n");
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Test Start: 13 OCT 2010 \n");
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Test Complete: 27 OCT 2010 \n");
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Requirement: JDK 1.6 \n");
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Feedback on: \n");
		rr.setText(rr.getText()+"           1.pravin.rane38@gmail.com \n");
...
//End
		...
		try{
		System.out.println("\n\n\n\n\n");
		System.out.println("Software Name: E-Security");
		try{Thread.sleep(2000);}catch(Exception hy){}
		System.out.println("Version Info: 1.0.0.1");
		Thread.sleep(2000);
		System.out.println("Author: Pravin H. Rane");
		Thread.sleep(2000);
		System.out.println("Tester: Rahul Sadafule");
		Thread.sleep(2000);
		System.out.println("Beta Version Tester: Sameer Gaware");
		Thread.sleep(2000);
		System.out.println("DFD Concept: Shekhar Parulekar");
		Thread.sleep(2000);
		System.out.println("Database By: E-Security");
		Thread.sleep(2000);
		System.out.println("Realising Date: 1 OCT 2010");
		Thread.sleep(2000);
		System.out.println("Test Start: 13 OCT 2010");
		Thread.sleep(2000);
		System.out.println("Test Complete: 27 OCT 2010");
		Thread.sleep(2000);
		System.out.println("Requirement: JDK 1.6");
		Thread.sleep(2000);
		System.out.println("Feedback on:");
		System.out.println("           1.pravin.rane38@gmail.com");
		System.out.println("           2.www.e-security.co.in   ");
		Thread.sleep(4000);
		}catch(Exception e){}
		}
